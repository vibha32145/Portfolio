    ...
    <section id="about" className="py-20 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-3xl mx-auto leading-relaxed text-lg text-gray-700 dark:text-gray-300 space-y-6">
          ...
          <a
            href="https://www.linkedin.com/in/vibha-gupta-257952296/overlay/1747465990542/single-media-viewer/?profileId=ACoAAEev7-MBNW-uIGKjO9x2Yf7BtK9sCLsScCg" // Update with your resume path
            target="_blank"
